		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Atualizar tabelas de Parâmetros",
									"targetURL": "#portosegurozpstaparametros-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"portosegurozpstaparametros-display": {
								"semanticObject": "portosegurozpstaparametros",
								"action": "display",
								"description": "Atualizar tabelas de Parâmetros",
								"title": "Atualizar tabelas de Parâmetros",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=portoseguro.zpstaparametros",
									"url": sap.ui.require.toUrl("portoseguro/zpstaparametros")
								}
							}
						}
					}
